...
logger = logging.getLogger("Unmanic.Plugin.remove_all_subtitles")
...
class PluginStreamMapper(StreamMapper):
    ...
    def test_stream_needs_processing(self, stream_info: dict):
        # Always return True as we are always removing all subtitle streams
        return True
