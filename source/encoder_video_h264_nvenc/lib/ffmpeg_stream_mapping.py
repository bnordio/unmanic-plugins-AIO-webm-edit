...
"""
    unmanic.ffmpeg_stream_mapping.py
...
class FfmpegStreamMapper(object):
    probe = {}
    ...
    def __init__(self, logger: Logger, processing_stream_type=None, probe=None):
        self.logger = logger
    ...
    def file_probe(self, file_path):
        ...
        try:
            ...
            self.probe = unffmpeg.Info().file_probe(file_path)
